...
import { isUserSubscribedService } from "../services/subscription.service.js";
...
export const summaryAnalyticsController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      ...
      .json({ message: "Summary fetched successfully", data });
  },
);
...
export const chartAnalyticsController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(HTTPSTATUS.OK)
      .json({ message: "Chart data fetched successfully", data });
  },
);
...
export const expensePieChartBreakdownController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(HTTPSTATUS.OK)
      .json({ message: "Expense breakdown fetched successfully", data });
  },
);
