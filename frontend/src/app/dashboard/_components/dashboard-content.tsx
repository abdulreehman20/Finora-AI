          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-xl border border-white/15 bg-white/5 py-2.5 pl-3 pr-8 text-sm text-zinc-300 outline-none hover:border-white/25 transition-all cursor-pointer disabled:cursor-wait disabled:opacity-60"
              >
                {DASHBOARD_PRESETS.map((p) => {
                  const isLocked = !planLoading && !isPro && p.value !== "1W";
                  return (
